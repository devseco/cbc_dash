...
<body>
    ...
    <span class="navbar-toggler-icon"></span>
              ...
              <a href="users.html" class="list-group-item list-group-item-action py-2 ripple active" ><i
      ...
      <main style="margin-top: 10px;">
        <div class="container pt-3  justify-content-center" >
            <section id="boxes" class="py-5">
                <div class="container">
                      <h1 class="details">اسم المستخدم / تعديل</h1>
                   <br/>
                   <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">اسم المستخدم</span>
                    </div>
                    <input type="text" class="form-control" aria-label="اسم المستخدم" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">رقم الهاتف</span>
                    </div>
                    <input type="text" class="form-control" aria-label="رقم الهاتف" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">المحافظة</span>
                    </div>
                    <input type="text" class="form-control" aria-label="المحافظة" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">العنوان</span>
                    </div>
                    <input type="text" class="form-control" aria-label="العنوان" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">كلمة السر</span>
                    </div>
                    <input type="text" class="form-control" aria-label="كلمة السر" aria-describedby="inputGroup-sizing-default">
                  </div>
