  ...
  <input id="file-input" type="file"  />
                   ...
                   <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">اسم المنتج</span>
                    </div>
                    <input type="text" class="form-control" id="title" value="<?php echo $old_title; ?>" aria-label="اسم المنتج" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">سعر المنتج</span>
                    </div>
                    <input type="text" class="form-control" id="price" value="<?php echo $old_price; ?>" aria-label="سعر المنتج" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">السعر السابق</span>
                    </div>
                    <input type="text" class="form-control" id="discount" value="<?php echo $old_discount; ?>" aria-label="السعر السابق" aria-describedby="inputGroup-sizing-default">
                    
                  </div>
                   <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">السعر الشراء</span>
                    </div>
                    <input type="text" class="form-control" id="buy" value="<?php echo $old_buy; ?>" aria-label="السعر الشراء" aria-describedby="inputGroup-sizing-default">
                   ...
                   <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="count" value="<?php echo $old_count; ?>" aria-label="العدد" aria-describedby="inputGroup-sizing-default">
                  </div>
                  <input type="hidden" id="item" value="<?php echo $id; ?>">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroup-sizing-default">معلومات المنتج</span>
                    </div>
                    <input type="text" class="form-control" id="des" value="<?php echo $old_des; ?>" aria-label="معلومات المنتج" aria-describedby="inputGroup-sizing-default">
                  </div>
    ...
    $("#save").click(function(){
     ...
     $.ajax({
                url         : 'api/upload_item.php',     // point to server-side PHP script 
